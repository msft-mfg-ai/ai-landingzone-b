...
{
    internal static IServiceCollection AddAzureServices(this IServiceCollection services, ChatApiOptions configuration)
    {
    ...
    internal static IServiceCollection AddAzureWithMICredentialsServices(this IServiceCollection services, ChatApiOptions configuration)
    {
        var sp = services.BuildServiceProvider();
        var httpContextAccessor = sp.GetRequiredService<IHttpContextAccessor>();
